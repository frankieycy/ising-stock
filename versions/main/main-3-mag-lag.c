...
/*
# Model
Magnetisation-dependent-lag model
daily num of trades correlating with magnetisation in prev day
...
* prob control B    = 1
* spin coupling J   = 1
* daily trades dt   = poisson(200*M^(2/7)+60)
*/
...
void update(){
	...
	dt=poisson(200*pow(M[t-1]*M[t-1],1./7)+60);
